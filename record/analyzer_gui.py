...
class LSLDataAnalyzer:
    ...
    def analyze_data(self, data_buffers, marked_timestamps):
        ...
        for stream in streams:
            ...
            # Split data based on longer pauses between timestamps (more than 10 seconds)
            segments = []
            current_segment = []
            ...
            # Analyze each segment and associate episodes within them
            for idx, segment in enumerate(segments):
                ...
                # Analyze data between marked timestamps if available, within this segment
                if marked_timestamps:
                    ...
                    for i in range(len(all_boundaries) - 1):
                        ...
                        if episode_values:
                            ...
                            segment_episodes.append((mean_episode, median_episode, min_episode, max_episode, std_dev_episode, iqr_episode, duration_episode, rmssd_episode))

                    for i, (mean_episode, median_episode, min_episode, max_episode, std_dev_episode, iqr_episode, duration_episode, rmssd_episode) in enumerate(segment_episodes):
